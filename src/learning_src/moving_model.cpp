...
int main(int argc, char **argv)
{
    ...
    */
    ...
    auto ik_pb_yaml = YAML::LoadFile("/home/riccardo/catkin_ws/src/package_first/src/pb_def_mov.yaml");
    ...
    auto task = solver->getTask("motion_of_model");    // The returned task i GenericTask type. It is required to cast
